    ...
    <div className="relative min-h-screen bg-nbdark text-white overflow-hidden hide-cursor">
      ...
      <div className="pt-24 md:pt-32">
        ...
        <Section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <Card 
                key={benefit.title} 
                className={`bg-white/5 border-white/10 backdrop-blur-sm overflow-hidden group cursor-pointer transition-all duration-500 ${activeCard === index ? 'border-nborange/50 bg-white/10 transform -translate-y-2' : 'hover:-translate-y-1'}`}
        ...
        <Section className="bg-gradient-to-r from-nborange/20 to-nbyellow/20 backdrop-blur-sm">
          <div className="max-w-3xl mx-auto text-center hidden-element opacity-0 animate-fade-in" style={{animationDelay: "0.8s", animationFillMode: "forwards"}}>
            ...
            <a href="https://www.keka.com/" target="_blank" rel="noopener noreferrer">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-nborange to-nbyellow text-white font-medium px-14 py-8 text-xl rounded-md transition-all duration-300 hover:shadow-lg hover:scale-105"
              >
                Join Now
              </Button>
            </a>
        ...
        {/* FAQ Section */}
        <Section>
          <h2 className="text-3xl md:text-4xl font-bold font-display mb-8 text-center hidden-element opacity-0 animate-fade-in" style={{animationDelay: "1s", animationFillMode: "forwards"}}>
            Frequently Asked <span className="text-gradient">Questions</span>
          </h2>
          
          <div className="max-w-3xl mx-auto hidden-element opacity-0 animate-fade-in" style={{animationDelay: "1.2s", animationFillMode: "forwards"}}>
        ...
        {/* Final CTA */}
        <Section>
          <div className="max-w-xl mx-auto text-center hidden-element opacity-0 animate-fade-in" style={{animationDelay: "1.4s", animationFillMode: "forwards"}}>
            ...
            <p className="text-nbgray mb-8">
              Reach out to our team at <a href="mailto:careers@nbmedia.com" className="text-gradient">careers@nbmedia.com</a> and we'll get back to you asap!
            </p>
            <a href="https://www.keka.com/" target="_blank" rel="noopener noreferrer">
              <Button 
                size="lg" 
                className="bg-nborange hover:bg-nborange/90 text-white font-medium px-8 py-4 rounded-md transition-all duration-300 hover:shadow-lg hover:scale-105"
              >
